...
const StatCard = ({ 
  ...
  const colorClasses = {
    blue: 'bg-[#F4F3EE] text-[#C15F3C]',
    green: 'bg-[#F4F3EE] text-[#C15F3C]',
    purple: 'bg-[#F4F3EE] text-[#B1ADA1]',
    orange: 'bg-[#F4F3EE] text-[#C15F3C]',
  };
...
const QuickActionCard = ({ 
  ...
  return (
    <Link href={href}>
      ...
      >
        <div className={`p-3 rounded-xl ${color === 'crail' ? 'bg-[var(--color-crail)]' : 'bg-[#F4F3EE]'} w-fit mb-4 group-hover:scale-110 transition-transform`}>
          <Icon className={`w-6 h-6 ${color === 'crail' ? 'text-white' : 'text-stone-600'}`} />
        </div>
  ...
  return (
    <div className="space-y-8">
      ...
      <motion.div
        ...
        className="bg-[var(--color-primary)] rounded-2xl p-8 text-white shadow-xl"
      >
      ...
      <div>
        ...
        <div className="bg-white rounded-2xl p-8 shadow-sm border border-[#B1ADA1]/20 text-center">
          ...
          <p className="text-sm text-[#B1ADA1] mt-1">
