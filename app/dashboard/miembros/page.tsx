    ...
    <div className="space-y-8 animate-in fade-in duration-500">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-white p-6 rounded-2xl border border-[#B1ADA1]/30 shadow-sm relative overflow-hidden group">
          <div className="absolute top-0 right-0 w-24 h-24 bg-[var(--color-crail)]/5 rounded-bl-[100px] -z-10 group-hover:scale-110 transition-transform duration-500"></div>
        ...
        <div className="bg-white p-6 rounded-2xl border border-[#B1ADA1]/30 shadow-sm relative overflow-hidden group">
          <div className="absolute top-0 right-0 w-24 h-24 bg-green-500/5 rounded-bl-[100px] -z-10 group-hover:scale-110 transition-transform duration-500"></div>
          <div className="flex items-center gap-4">
        ...
        <div className="bg-white p-6 rounded-2xl border border-[#B1ADA1]/30 shadow-sm relative overflow-hidden group">
          <div className="absolute top-0 right-0 w-24 h-24 bg-yellow-500/5 rounded-bl-[100px] -z-10 group-hover:scale-110 transition-transform duration-500"></div>
          <div className="flex items-center gap-4">
                ...
                <tr>
                  <td colSpan={5} className="py-12 px-6 text-center text-stone-500">
                    <div className="flex flex-col items-center justify-center">
                      ...
                      <p className="font-medium text-stone-900">No hay miembros registrados</p>
                      <p className="text-sm mt-1">Cuando los usuarios se afilien, aparecerán aquí.</p>
                    </div>
                  </td>
                </tr>
              ) : (
                members.map((member, i) => (
                  ...
                  >
                    <td className="py-4 px-6">
                      <div className="flex items-center gap-3">
                        <div className="w-10 h-10 rounded-full bg-[var(--color-pampas)] flex items-center justify-center text-[var(--color-crail)] font-serif font-bold border border-[#B1ADA1]/20">
                          {member.fullName ? member.fullName.charAt(0).toUpperCase() : member.user?.name?.charAt(0).toUpperCase() || 'M'}
                        </div>
                        <div>
