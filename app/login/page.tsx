  ...
  return (
    ...
    >
      <div className="w-full max-w-[900px] flex flex-col md:flex-row gap-8 items-center z-10">
        ...
        {/* Lado Izquierdo: Mensaje Editorial */}
        <div className="flex-1 text-center md:text-left space-y-6 md:pr-8">
          ...
          >
            Accede al panel central de administración. Diseñado para simplificar
            la gestión de tu institución y automatizar la suscripción de miembros
            de forma clara y centralizada.
          </p>
        </div>
      ...
      {/* Blobs decorativos */}
      <div className="absolute top-[-10%] left-[-10%] w-96 h-96 bg-[var(--color-crail)] rounded-full mix-blend-multiply filter blur-3xl opacity-10 pointer-events-none" />
      <div className="absolute bottom-[-10%] right-[-10%] w-96 h-96 bg-[var(--color-cloudy)] rounded-full mix-blend-multiply filter blur-3xl opacity-10 pointer-events-none" />
    </div>
  );
}
